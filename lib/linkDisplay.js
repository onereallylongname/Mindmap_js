class LinkDisplay {
  ...
  processe(layer, link){
    console.log(link, this.tempTree.nodes[link.from], this.tempTree.nodes[link.from].disp.pos, this.tempTree.nodes[link.to], this.tempTree.nodes[link.to].disp.pos);
